# -*- encoding: utf-8 -*-
# stub: logstash-filter-fingerprint 3.2.1 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-filter-fingerprint".freeze
  s.version = "3.2.1"
  ...
  s.summary = "Fingerprints fields by replacing values with a consistent hash".freeze
